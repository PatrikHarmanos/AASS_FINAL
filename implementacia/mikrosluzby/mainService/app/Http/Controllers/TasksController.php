...
//        $this->middleware('auth:api', ['except' => ['indexAll']]);
    ...
    {
        try {
            $response = Http::get('http://localhost:8002/api/tasks');
            $data = $response->json();

            return $this->responseSuccess($data, 'New Task Created Successfully !');
    ...
    public function store(ProductRequest $request): JsonResponse
    {
        try {
            ...
            $response = Http::post('http://localhost:8002/api/tasks', [
